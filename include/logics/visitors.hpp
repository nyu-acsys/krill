...
namespace plankton {
    ...
    struct NonSeparatingImplication;
    ...
    struct LogicVisitor {
        ...
        virtual void Visit(const NonSeparatingImplication& object) = 0;
        virtual void Visit(const ImplicationSet& object) = 0;
        ...
        void Walk(const NonSeparatingImplication& object);
        void Walk(const ImplicationSet& object);
    ...
    struct LogicListener : public LogicVisitor {
        ...
        virtual void Enter(const NonSeparatingImplication& object);
        virtual void Enter(const ImplicationSet& object);
    ...
    struct MutableLogicVisitor {
        ...
        virtual void Visit(NonSeparatingImplication& object) = 0;
        virtual void Visit(ImplicationSet& object) = 0;
        ...
        void Walk(NonSeparatingImplication& object);
        void Walk(ImplicationSet& object);
    ...
    struct MutableBaseLogicVisitor : public MutableLogicVisitor {
        ...
        void Visit(ImplicationSet& object) override;
    ...
    struct MutableLogicListener : public MutableLogicVisitor {
        ...
        virtual void Enter(NonSeparatingImplication& object);
        virtual void Enter(ImplicationSet& object);
