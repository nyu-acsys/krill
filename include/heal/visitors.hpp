...
namespace heal {
	...
	struct LogicNonConstVisitor {
		...
		virtual void visit(NegationFormula& formula) = 0;
	...
	struct BaseLogicVisitor : public LogicVisitor {
		...
		virtual void visit(const NegationFormula& /*formula*/) override { throw cola::VisitorNotImplementedError(*this, "BaseLogicVisitor", "const NegatedAxiom&"); }
		...
		virtual void visit(const UniqueInflowAxiom& /*formula*/) override { throw cola::VisitorNotImplementedError(*this, "BaseLogicVisitor", "const UniqueInflowAxiom&"); }
	...
	struct BaseLogicNonConstVisitor : public LogicNonConstVisitor {
		...
		virtual void visit(NegationFormula& /*formula*/) override { throw cola::VisitorNotImplementedError(*this, "BaseLogicNonConstVisitor", "visit(NegatedAxiom&"); }
		...
		virtual void visit(UniqueInflowAxiom& /*formula*/) override { throw cola::VisitorNotImplementedError(*this, "BaseLogicNonConstVisitor", "visit(UniqueInflowAxiom&"); }
	...
	struct LogicListener : public LogicVisitor {
		...
		void visit(const UniqueInflowAxiom& formula) override { enter(formula); exit(formula); }
		...
		virtual void enter(const NegationFormula& formula) = 0;
		...
		virtual void exit(const NegationFormula& formula) = 0;
	...
	struct LogicNonConstListener : public LogicNonConstVisitor {
		...
		void visit(NegationFormula& formula) override;
		...
		void visit(UniqueInflowAxiom& formula) override { enter(formula); exit(formula); }
		...
		virtual void enter(NegationFormula& formula) = 0;
		...
		virtual void exit(NegationFormula& formula) = 0;
	...
	struct DefaultListener : public LogicListener {
		...
		virtual void enter(const NegationFormula& /*formula*/) override {}
		...
		virtual void enter(const UniqueInflowAxiom& /*formula*/) override {}
		...
		virtual void exit(const NegationFormula& /*formula*/) override {}
		...
		virtual void exit(const UniqueInflowAxiom& /*formula*/) override {}
	...
	struct DefaultNonConstListener : public LogicNonConstListener {
		...
		virtual void enter(NegationFormula& /*formula*/) override {}
		...
		virtual void enter(UniqueInflowAxiom& /*formula*/) override {}
		...
		virtual void exit(NegationFormula& /*formula*/) override {}
		...
		virtual void exit(UniqueInflowAxiom& /*formula*/) override {}
