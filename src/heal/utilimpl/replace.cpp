...
std::unique_ptr<Expression> heal::replace_expression(std::unique_ptr<Expression> expression, const transformer_t& transformer, bool* changed) {
	return make_replacement(std::move(expression), transformer, changed);
}

std::unique_ptr<Formula> heal::replace_expression(std::unique_ptr<Formula> formula, const transformer_t& transformer, bool* changed) {
	return make_replacement(std::move(formula), transformer, changed);
}

std::unique_ptr<SimpleFormula> heal::replace_expression(std::unique_ptr<SimpleFormula> formula, const transformer_t& transformer, bool* changed) {
	return make_replacement(std::move(formula), transformer, changed);
}

std::unique_ptr<Axiom> heal::replace_expression(std::unique_ptr<Axiom> formula, const transformer_t& transformer, bool* changed) {
	return make_replacement(std::move(formula), transformer, changed);
}

std::unique_ptr<ConjunctionFormula> heal::replace_expression(std::unique_ptr<ConjunctionFormula> formula, const transformer_t& transformer, bool* changed) {
	return make_replacement(std::move(formula), transformer, changed);
}

std::unique_ptr<TimePredicate> heal::replace_expression(std::unique_ptr<TimePredicate> formula, const transformer_t& transformer, bool* changed) {
	return make_replacement(std::move(formula), transformer, changed);
}
...
std::unique_ptr<Expression> heal::replace_expression(std::unique_ptr<Expression> expression, const cola::Expression& replace, const cola::Expression& with, bool* changed) {
	return heal::replace_expression(std::move(expression), make_transformer(replace, with), changed);
}

std::unique_ptr<Formula> heal::replace_expression(std::unique_ptr<Formula> formula, const cola::Expression& replace, const cola::Expression& with, bool* changed) {
	return heal::replace_expression(std::move(formula), make_transformer(replace, with), changed);
}

std::unique_ptr<Axiom> heal::replace_expression(std::unique_ptr<Axiom> formula, const cola::Expression& replace, const cola::Expression& with, bool* changed) {
	return heal::replace_expression(std::move(formula), make_transformer(replace, with), changed);
}

std::unique_ptr<SimpleFormula> heal::replace_expression(std::unique_ptr<SimpleFormula> formula, const cola::Expression& replace, const cola::Expression& with, bool* changed) {
	return heal::replace_expression(std::move(formula), make_transformer(replace, with), changed);
}

std::unique_ptr<ConjunctionFormula> heal::replace_expression(std::unique_ptr<ConjunctionFormula> formula, const cola::Expression& replace, const cola::Expression& with, bool* changed) {
	return heal::replace_expression(std::move(formula), make_transformer(replace, with), changed);
}

std::unique_ptr<TimePredicate> heal::replace_expression(std::unique_ptr<TimePredicate> formula, const cola::Expression& replace, const cola::Expression& with, bool* changed) {
	return heal::replace_expression(std::move(formula), make_transformer(replace, with), changed);
}
