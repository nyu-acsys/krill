...
template<>
std::vector<bool> solver::ComputeImplied<false>(z3::solver& solver, const z3::expr_vector& expressions, bool* isSolverUnsatisfiable) {
    return ComputeImpliedInOneShot(solver, expressions, isSolverUnsatisfiable);
}

template<>
std::vector<bool> solver::ComputeImplied<true>(z3::solver& solver, const z3::expr_vector& expressions, bool* isSolverUnsatisfiable) {
    return ComputeImpliedOneAtATime(solver, expressions, isSolverUnsatisfiable);
}
...
void solver::ComputeImpliedCallback(z3::solver& solver, const ImplicationCheckSet& checks, bool* isSolverUnsatisfiable) {
    auto implied = ComputeImplied<fallback>(solver, checks.expressions, isSolverUnsatisfiable);
...
template void solver::ComputeImpliedCallback<true>(z3::solver& solver, const ImplicationCheckSet& checks, bool* isSolverUnsatisfiable);
template void solver::ComputeImpliedCallback<false>(z3::solver& solver, const ImplicationCheckSet& checks, bool* isSolverUnsatisfiable);